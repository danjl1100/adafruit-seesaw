const DELAY_TIME_US: u32 = 125;

pub use blocking::{Driver, DriverExt, I2cDriver};
mod blocking {
    use super::DELAY_TIME_US;
...
mod non_blocking {
    const DELAY_TIME: Duration = Duration::from_micros(super::DELAY_TIME_US as u64);
